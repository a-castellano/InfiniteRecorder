...
function record_video {
	record_vide_command="
ffmpeg -y -i $1 -c copy  -map 0 -f segment -segment_time ${VIDEO_LENGTH} -segment_format mp4 -strftime 1 \"$2/record-%Y-%m-%d_%H-%M-%S.mp4\" -use_wallclock_as_timestamps 1 -reset_timestamps 1 -vcodec libx264 -metadata title=\"$3\""
